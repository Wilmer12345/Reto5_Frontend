function autoInicioCategoria(){
    ...
    $.ajax({
        url:"http://168.138.143.97:8080/api/Category/all",
        type:"GET",
        datatype:"JSON",
...
function cargarDatosCabin(id) {
    $.ajax({
        dataType: 'json',
        url:"http://168.138.143.97:8080/api/Cabin/"+id,
    ...
    if($("#name2").val().length == 0 || $("#brand").val().length == 0 || $("#year").val().length == 0 || $("#description2").val().length == 0){
       alert("Todos los campos son obligatorios")
            ...
            $.ajax({
                ...
                url:"http://168.138.143.97:8080/api/Cabin/save",
    ...
    $.ajax(
        {
            dataType: 'json',
            data: dataToSend,
            url:"http://168.138.143.97:8080/api/Cabin/"+idElemento,
...
function actualizar(idElemento) {
    ...
    if($("#name2").val().length == 0 || $("#brand").val().length == 0 || $("#year").val().length == 0 || $("#description2").val().length == 0){
        ...
        $.ajax({
            ...
            data: dataToSend,
            contentType: "application/JSON",
            url:"http://168.138.143.97:8080/api/Cabin/update",
